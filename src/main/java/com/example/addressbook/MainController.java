...
public class MainController {
    ...
    private void syncContacts() {
        ...
        contactContainer.setManaged(hasContact);
    }
    ...
    private void onDelete() {
        ...
        if (selectedContact != null) {
            ...
            Contact nextSelected = contactsListView.getSelectionModel().getSelectedItem();
            if (nextSelected == null && !contactsListView.getItems().isEmpty()) {
                contactsListView.getSelectionModel().selectFirst();
                nextSelected = contactsListView.getSelectionModel().getSelectedItem();
            }

            if (nextSelected != null) {
                selectContact(nextSelected);
            } else {
